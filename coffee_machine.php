          ...
          <div class="row my-3">
            <div class="col-sm-6 text-center">
              <div id="display" class="p-3 text-center">
                ...
                <p><i class="fas fa-coins"></i> Баланс: <span id="displayBalance">0</span>руб.</p>
              ...
              <button id="changestyle" class="btn btn-lg btn-light my-3" onclick="getChange(money.value)"><i class="fas fa-coins"></i> Выдать сдачу </button>
              <img id="coffeecup" src="img/coffee-cup.png" alt="coffee cup">
            </div>
            <div class="col-sm-6 text-center">
